const BookingRespository = require("../repository/booking-respository")
...
class BookingService {
    ...
    async createBooking(data ){ 
        try {
            ...
            await axios.patch(updateFlightRequestURL, {totalSeatsAvailable: flightData.totalSeatsAvailable - booking.noOfSeats});
